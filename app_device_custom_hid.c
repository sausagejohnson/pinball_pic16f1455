...
typedef enum
{
    COMMAND_TOGGLE_PLAYER_LED = 0x80,
    COMMAND_TOGGLE_LAUNCH_LED = 0x86,
    COMMAND_GET_BUTTON_STATUS = 0x81,
    COMMAND_PLAYER_LED_ON = 0x82,    
    COMMAND_PLAYER_LED_OFF = 0x83,
    COMMAND_LAUNCH_LED_ON = 0x84,    
    COMMAND_LAUNCH_LED_OFF = 0x85,
...
{   
    ...
    {   
        ...
        {
            case COMMAND_TOGGLE_PLAYER_LED:  //Toggle LED
                LED_Toggle(LED_PLAYER_BUTTON);
                break;
            case COMMAND_TOGGLE_LAUNCH_LED:  //Toggle LED
                LED_Toggle(LED_LAUNCH_BUTTON);
                break;
            case COMMAND_PLAYER_LED_ON:
                LED_On(LED_PLAYER_BUTTON);
                break;
            case COMMAND_PLAYER_LED_OFF:
                LED_Off(LED_PLAYER_BUTTON);
                break;
            case COMMAND_LAUNCH_LED_ON:
                LED_On(LED_LAUNCH_BUTTON);
                break;
            case COMMAND_LAUNCH_LED_OFF:
            ...
            case COMMAND_GET_BUTTON_STATUS:  //Get push button state
                ...
                if(!HIDTxHandleBusy(USBInHandle))
                {
                    ...
                    if(BUTTON_IsPressed(BUTTON_LEFT_FLIPPER) == false)	//pushbutton not pressed, pull up resistor on circuit board is pulling the PORT pin high
                    {
                    ...
                    if(BUTTON_IsPressed(BUTTON_RIGHT_FLIPPER) == false)	//pushbutton not pressed, pull up resistor on circuit board is pulling the PORT pin high
                    {
                    ...
                    if(BUTTON_IsPressed(BUTTON_PLAYER) == false)	//pushbutton not pressed, pull up resistor on circuit board is pulling the PORT pin high
                    {
                    ...
                    if(BUTTON_IsPressed(BUTTON_LAUNCH) == false)	//pushbutton not pressed, pull up resistor on circuit board is pulling the PORT pin high
                    {
                    ...
                    if(BUTTON_IsPressed(BUTTON_ADMIN) == false)	//pushbutton not pressed, pull up resistor on circuit board is pulling the PORT pin high
                    {
                            ToSendDataBuffer[5] = 0x01;
                    }
                    else									//sw3 must be == 0, pushbutton is pressed and overpowering the pull up resistor
                    {
                            ToSendDataBuffer[5] = 0x00;
                    }
                    if(BUTTON_IsPressed(SWITCH_LEFT_TILT) == false)	//pushbutton not pressed, pull up resistor on circuit board is pulling the PORT pin high
                    {
                            ToSendDataBuffer[6] = 0x01;
                    }
                    else									//sw3 must be == 0, pushbutton is pressed and overpowering the pull up resistor
                    {
                            ToSendDataBuffer[6] = 0x00;
                    }
                    if(BUTTON_IsPressed(SWITCH_RIGHT_TILT) == false)	//pushbutton not pressed, pull up resistor on circuit board is pulling the PORT pin high
                    {
                            ToSendDataBuffer[7] = 0x01;
                    }
                    else									//sw3 must be == 0, pushbutton is pressed and overpowering the pull up resistor
                    {
                            ToSendDataBuffer[7] = 0x00;
                    }
