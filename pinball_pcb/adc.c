...
bool ADC_Enable(ADC_CHANNEL channel)
{
    ...
    {
        case ADC_CHANNEL_10:
            TRISAbits.TRISA4 = PIN_INPUT; //just a guess, not sure if this A4 is appropriate for pic16f1455
            //ANSELAbits.ANSA4 = PIN_ANALOG; //just a guess, not sure if this A4 is appropriate for pic16f1455
            ANSELAbits.ANSA4 = PIN_DIGITAL; //Setting to digital because right flipper wouldn't work.
            
	    //Now do the ANSELC ones because Admin and Tilt Right (RC2 and RC3) wouldn't work
	    TRISCbits.TRISC2 = PIN_INPUT;
	    TRISCbits.TRISC3 = PIN_INPUT;
	    ANSELCbits.ANSC2 = PIN_DIGITAL;
	    ANSELCbits.ANSC3 = PIN_DIGITAL;
