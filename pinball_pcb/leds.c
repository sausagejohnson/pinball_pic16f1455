...
#define LED_C0_LAT LATCbits.LATC0
#define LED_C1_LAT LATCbits.LATC1

#define LED_C0_TRIS TRISCbits.TRISC0
#define LED_C1_TRIS TRISCbits.TRISC1
...
bool LED_Get(LED led)
{
    ...
    {
        case LED_C0:
            return ( (LED_C0_LAT == LED_ON) ? true : false );
			
        case LED_C1:
            return ( (LED_C1_LAT == LED_ON) ? true : false );
...
void LED_Enable(LED led)
{
    ...
    {
        case LED_C0:
            LED_C0_TRIS = PIN_OUTPUT;
            break;
			
        case LED_C1:
            LED_C1_TRIS = PIN_OUTPUT;
            break;
